...
export default function Sidebar({ activeRoomId, onSelectRoom, onOpenSearch }: Props) {
  ...
  return (
    <aside className="bg-[#19171d] border-r border-black/30 flex flex-col w-[260px] shrink-0 select-none">
      ...
      {/* Search bar */}
      <div className="px-3 pt-2.5 pb-1.5 shrink-0 flex gap-2">
        <div className="flex items-center gap-2 flex-1 bg-white/10 hover:bg-white/15 rounded px-2.5 py-1.5 transition-colors">
        ...
        <button
          ...
          className="flex items-center justify-center w-8 h-[34px] rounded bg-white/10 hover:bg-white/20 text-white/50 hover:text-white transition-colors shrink-0"
        >
